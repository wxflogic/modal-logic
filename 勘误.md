...
| 123 | 倒数第 9 行 | 定义 7.1.19(2) | 定义$\vdash_{\Lambda}\subseteq\wp(\mathcal{L_\square})\times\mathcal{L}$如下 | 定义$\vdash_{\Lambda}\subseteq\wp(\mathcal{L_\square})\times\mathcal{L_\square}$如下 | 黎欣鑫 |
